...
class ValueConverter implements ValueConverterInterface
{
    ...
    public function convert($object, PropertyMetadata $property, PropertyAccessor $accessor)
    {
        ...
        if (!$property->multi) {
            $value = $property->propertyPath ? $accessor->getValue($object, $property->propertyPath):$property->getValue($object);
        }
    ...
    {
        $traversable = $property->propertyPath ? $accessor->getValue($object, $property->propertyPath):$property->getValue($object);
